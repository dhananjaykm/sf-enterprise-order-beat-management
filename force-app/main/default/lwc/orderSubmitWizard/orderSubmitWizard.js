 ...
 *
 * MIGRATION: F — replace with lightning-flow once Order_Submit_Screen exists.
 */
export default class OrderSubmitWizard extends LightningElement {
    @api recordId;
    @track error;
    @track rows = [];
    columns = [
    ...
    handleApply() {
        this.error = 'Flow Order_Submit_Screen is not deployed in this legacy pro-code org.';
    }
